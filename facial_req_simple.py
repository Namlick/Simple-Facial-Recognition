...
# src = 0 : for the built in single web cam, could be your laptop webcam
...
#	frame = cv2.Canny(frame, 20, 50)
	...
	names = []
		...
		#new appearance counters
	#cv2.putText(frame, f"Nick: {str(Ncounter)}", (100, 50), cv2.FONT_HERSHEY_SIMPLEX,
	#	0.5, (0, 255, 255), 2)
	#cv2.putText(frame, f"Lauren: {str(Lcounter)}", (300, 50), cv2.FONT_HERSHEY_SIMPLEX,
	#	0.5, (0, 255, 255), 2)
